...
Generates time series plots for performance analysis.
"""
import pandas as pd
import numpy as np
...
def create_single_poi_plot(row, landfall_date=None, save_path=None, show_confidence=False):
...
def plot_best_worst_pois(csv_path, output_dir=None, num_plots=10, show_confidence=False):
    """
    ...
    Args:
        ...
        show_confidence: Whether to show confidence intervals (deprecated - kept for compatibility)
    """
    # Load data
